...
const PostContent = ({ post, isLiked, onLike, onComment,onShare }) => {
  const userPostPlaceholder = post?.userId?.username
    ?.split(" ")
    .map((name) => name[0])
    .join("");
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <div className="flex justify-between items-center mb-4">
            <span className="text-sm text-gray-500 dark:text-gray-400 hover:border-b-2 cursor-pointer">
              {post?.likeCount} likes
            </span>
            <div className="flex gap-3">
              <span
                className="text-sm text-gray-500 dark:text-gray-400 hover:border-b-2 cursor-pointer"
